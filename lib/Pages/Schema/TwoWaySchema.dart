...
//
//     final roundTrip = roundTripFromJson(jsonString);

import 'dart:convert';

RoundTrip roundTripFromJson(String str) => RoundTrip.fromJson(json.decode(str));

String roundTripToJson(RoundTrip data) => json.encode(data.toJson());
...
class RoundTrip {
    ...
    factory RoundTrip.fromJson(Map<String, dynamic> json) => new RoundTrip(
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => new Datum(
        ...
        bagsPrice: json["bags_price"] == null ? null : new Map.from(json["bags_price"]).map((k, v) => new MapEntry<String, double>(k, v.toDouble())),
        ...
        routes: json["routes"] == null ? null : new List<List<String>>.from(json["routes"].map((x) => new List<String>.from(x.map((x) => x)))),
        ...
        foundOn: json["found_on"] == null ? null : new List<String>.from(json["found_on"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "bags_price": bagsPrice == null ? null : new Map.from(bagsPrice).map((k, v) => new MapEntry<String, dynamic>(k, v)),
        ...
        "routes": routes == null ? null : new List<dynamic>.from(routes.map((x) => new List<dynamic>.from(x.map((x) => x)))),
        ...
        "found_on": foundOn == null ? null : new List<dynamic>.from(foundOn.map((x) => x)),
