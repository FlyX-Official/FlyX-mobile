...
NearbyRequest nearbyRequestFromJson(String str) => NearbyRequest.fromJson(json.decode(str));
...
class Filter {
    ...
    factory Filter.fromJson(Map<String, dynamic> json) => Filter(
        geoDistance: json["geo_distance"] == null ? null : GeoDistance.fromJson(json["geo_distance"]),
    );
...
class Must {
    ...
    factory Must.fromJson(Map<String, dynamic> json) => Must(
        matchAll: json["match_all"] == null ? null : MatchAll.fromJson(json["match_all"]),
    );
