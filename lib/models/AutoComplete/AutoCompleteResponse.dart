...
AutoCompleteResponse autoCompleteResponseFromJson(String str) =>
    AutoCompleteResponse.fromJson(json.decode(str));

String autoCompleteResponseToJson(AutoCompleteResponse data) =>
...
class Hits {
  ...
  factory Hits.fromJson(Map<String, dynamic> json) => Hits(
        ...
        hits: json["hits"] == null
            ? null
            : List<dynamic>.from(json["hits"].map((x) => x)),
      );
...
class Suggest {
  ...
  factory Suggest.fromJson(Map<String, dynamic> json) => Suggest(
        ...
        iata: json["Iata"] == null
            ? null
            : List<City>.from(json["Iata"].map((x) => City.fromJson(x))),
        name: json["Name"] == null
            ? null
            : List<City>.from(json["Name"].map((x) => City.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Iata": iata == null
            ? null
            : List<dynamic>.from(iata.map((x) => x.toJson())),
        "Name": name == null
            ? null
