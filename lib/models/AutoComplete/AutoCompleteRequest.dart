...
AutoCompleteRequest autoCompleteRequestFromJson(String str) => AutoCompleteRequest.fromJson(json.decode(str));

String autoCompleteRequestToJson(AutoCompleteRequest data) => json.encode(data.toJson());
...
class AutoCompleteRequest {
    ...
    factory AutoCompleteRequest.fromJson(Map<String, dynamic> json) => AutoCompleteRequest(
