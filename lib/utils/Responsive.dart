...
DisplayType displayTypeOf(BuildContext context) => MediaQuery.of(context).size.shortestSide > _desktopBreakpoint ? DisplayType.desktop : DisplayType.mobile;

/// Returns a boolean if we are in a display of [DisplayType.desktop]. Used to
/// build adaptive and responsive layouts.
bool isDisplayDesktop(BuildContext context) => displayTypeOf(context) == DisplayType.desktop;
